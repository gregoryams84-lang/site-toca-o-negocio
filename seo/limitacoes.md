...
- **Página de Formalização aguardando revisão contábil.** O conteúdo já está no ar com linguagem deliberadamente genérica (sem prazo, valor ou percentual específico), mas não deve receber atualização de conteúdo sem um contador revisar antes — comentário HTML deixado no próprio arquivo como lembrete.
